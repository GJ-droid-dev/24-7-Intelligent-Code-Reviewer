...
export default function SubmitWorkspacePage() {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      // Navigate directly to dedicated review report/loading page
  ...
  return (
    <div className="space-y-6">
      ...
      <div className="flex flex-col md:flex-row md:items-center justify-between gap-4 pb-4 border-b border-[#262626]">
        ...
        <div className="flex items-center space-x-3">
          <button
            ...
            className="px-3.5 py-1.5 rounded bg-[#141414] hover:bg-[#1F1F1F] border border-[#262626] text-xs text-[#8F8F8F] hover:text-[#EBEBEB] transition-all font-mono"
          >
            Reset Template
          </button>
        </div>
      ...
      <form onSubmit={handleSubmit} className="space-y-5">
        ...
        <div className="rounded-xl bg-[#141414] border border-[#262626] p-5 space-y-4 shadow-sm">
          <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
            <div className="space-y-1.5">
              ...
              <input
                ...
                placeholder="e.g. Add customer order-history API"
          ...
          <div className="space-y-1.5">
            ...
            <textarea
              ...
              className="w-full px-3.5 py-2.5 rounded-lg bg-[#0A0A0A] border border-[#262626] text-xs text-[#EBEBEB] focus:outline-none focus:border-[#3291FF] resize-none leading-relaxed transition-colors"
            />
          </div>
        </div>

        {/* Monaco Code Editor (Full Width & Expanded Height) */}
